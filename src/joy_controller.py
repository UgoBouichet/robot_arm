...
class ControlRobotJoy:
	...
	def __init__(self):
		...
		self.pub_joint4 = rospy.Publisher("/robot_arm/joint5_position_controller/command",Float64, queue_size=1)
		self.pub_joint5 = rospy.Publisher("/robot_arm/joint6_position_controller/command",Float64, queue_size=1)
	...
	def joy_callback(self, msg):
		...
		if(gripper==1):
			...
			if(self.gripper_open==False):
				...
				print("Open Gripper")
				self.theta7=-0.8
				self.pub_joint7.publish(self.theta7)
				self.gripper_open=True
				self.joint7.data = self.theta7
